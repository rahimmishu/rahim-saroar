...
const LiteHero: React.FC = () => {
  // --- Typing Effect (lightweight, রাখা হয়েছে) ---
  ...
  return (
    ...
    >
      {/* 🎨 Lite CSS — শুধু static gradient, কোনো continuous animation নেই */}
      <style>{`
        /* Typing cursor — lightweight blink */
        ...
        /* Photo shimmer on hover — GPU-friendly transform only */
        .lite-photo-wrap:hover .lite-photo { transform: scale(1.04); }
        .lite-photo { transition: transform 0.5s ease; }
      `}</style>

      {/* 🟣 Background: Static gradient blobs (no animation) */}
      ...
      <div className="container relative z-10 px-4 mx-auto sm:px-6 lg:px-8">
        <div className="flex flex-col items-center gap-12 lg:flex-row lg:items-center lg:gap-16">
          ...
          {/* ===== RIGHT: Image (Lite — no Tilt3D, no spinning borders) ===== */}
          <div className="relative flex justify-center w-full lite-fade-4 lg:w-1/2 lg:justify-end">
            ...
            <div className="lite-photo-wrap relative z-10 w-64 sm:w-72 lg:w-[340px] xl:w-[380px]">
              ...
              {/* 🏷️ Badge 1 — Top Left (static, no animation) */}
              <div
