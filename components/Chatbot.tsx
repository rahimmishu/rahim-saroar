...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-[100px] right-4 md:right-8 z-50 w-[320px] md:w-[350px] bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 flex flex-col overflow-hidden animate-in slide-in-from-bottom-10 fade-in duration-300 font-sans">
          
...
      {/* Trigger Button - Hidden when chat is open to prevent overlap */}
      {!isOpen && (
        <button
          onClick={() => setIsOpen(true)}
          className="fixed bottom-[100px] right-8 z-50 group flex items-center justify-center w-14 h-14 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-110 bg-gradient-to-r from-blue-600 to-purple-600 text-white"
        >
