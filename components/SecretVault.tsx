  ...
  const secretCodes: { [key: string]: { 
    ...
    "hotcdi": { 
      ...
      items: [
        ...
        { type: 'video', src: 'https://drive.google.com/file/d/1oNTdU03qDdoPCscx5kqmsTdoFXueoXVp/preview', title: 'Slim Teen Tegan Lane Gets Fucked Hard on the Couch', thumbnail: '/f.jpg' },
