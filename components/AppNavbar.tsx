...
import ThemeToggle from './ThemeToggle'; // ✅ নতুন থিম টগল ইমপোর্ট করা হলো
...
const AppNavbar: React.FC<NavbarProps> = ({ isDarkMode, toggleTheme, onOpenTools, onOpenGallery }) => {
  ...
  const handleLinkClick = (e: React.MouseEvent<HTMLAnchorElement>, href: string) => {
    ...
    if (element) {
      // একটু সময় দেওয়া যাতে মেনু ক্লোজ এনিমেশন শেষ হয়
      setTimeout(() => {
        const offset = 85; // Navbar এর উচ্চতা বাদ দেওয়া
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="items-center hidden space-x-8 lg:flex">
              ...
              <div className="flex items-center pl-4 space-x-4 border-l border-slate-200 dark:border-slate-800">
                  {/* ✅ Animated Toggle Button Added Here */}
            ...
            <div className="lg:hidden flex items-center gap-3 z-[60]">
               {/* ✅ Animated Toggle Button Added Here too */}
               <ThemeToggle isDark={isDarkMode} toggleTheme={toggleTheme} />
