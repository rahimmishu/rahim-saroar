      ...
      >
        ...
        <div className={`relative z-10 flex items-center gap-4 w-full transition-all duration-500 delay-100 ${isExpanded ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
          ...
          <div className="relative shrink-0">
             ...
             <div className={`relative p-2 rounded-full ${type === 'success' ? 'bg-gradient-to-b from-green-500/20 to-green-900/20 text-green-400' : 'bg-gradient-to-b from-blue-500/20 to-blue-900/20 text-blue-400'}`}>
               {type === 'success' ? <CheckCircle size={20} /> : <BellRing size={20} className="animate-wiggle" />}
             </div>
          </div>
